...
description: "An opinionated Python workspace on Unix with pyenv and virtualenvwrapper — one Jupyter and iPython per major version, clean isolation for everything else."
---
